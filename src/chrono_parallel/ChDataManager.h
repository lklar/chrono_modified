...
struct host_container {
    ...
    custom_vector<real4> contact_coeff; ///< Stiffness and dampness coefficients per contact pair
    ...
    custom_vector<real> muR;                   ///< Coefficient of rolling friction (SMC only)
    custom_vector<real> muT;                   ///< Coefficient of twisting friction (SMC only)
